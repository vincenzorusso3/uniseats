...
public class PrenotazioneFailTestSystem {
  ...
  @Test
  public void testPrenotazione() throws Exception {
    driver.get("http://localhost:8080/UniSeats_war_exploded/view/LandingPageView.jsp");
    ...
    driver.findElement(By.id("calendar")).sendKeys("2021-01-27");
