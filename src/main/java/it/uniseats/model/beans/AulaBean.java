...
/**
 * Un oggetto <code>AulaBean</code> rappresenta un aula. Ogni aula ha un codice identificativo (A1, A2, ..),
 * un dipartimento di appartenenza (Fisica, Farmacia, ..), un numero totale di posti al suo interno, e
